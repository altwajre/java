...
import com.company.app.WhiskyVerticle;
...
public class WhiskyVerticleTest {
  ...
  public void setUp(TestContext context) throws IOException {
    ...
    vertx.deployVerticle(WhiskyVerticle.class.getName(), options, context.asyncAssertSuccess());
  }
