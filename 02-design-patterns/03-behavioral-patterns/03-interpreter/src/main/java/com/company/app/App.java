...
public class App
{
    static class Context{  // Context
        public Context(String input){ this.Input = input; }
        public String Input;
        public int Output;
    }
    static abstract class Expression{  // Abstract Expression
    ...
    static class ThousandExpression extends Expression{  // Terminal Expression
        @Override
    ...
    static class HundredExpression extends Expression{  // Terminal Expression
        @Override
    ...
    static class TenExpression extends Expression{  // Terminal Expression
        @Override
    ...
    static class OneExpression extends Expression{  // Terminal Expression
        @Override
