...
public class App
{
    ...
    static class CharA extends Char {  // Concrete Flyweight
        public CharA(){
            this.symbol = 'A';
            this.height = 100;
            this.width = 120;
    ...
    static class CharB extends Char {  // Concrete Flyweight
        public CharB(){
            this.symbol = 'B';
            this.height = 100;
            this.width = 140;
    ...
    static class CharZ extends Char {  // Concrete Flyweight
        public CharZ(){
            this.symbol = 'Z';
            this.height = 100;
            this.width = 100;
    ...
    static class CharFactory{  // FlyweightFactory
