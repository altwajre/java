 ...
 * 
 */
@WebServiceClient(name = "DemoService", targetNamespace = "http://soap/", wsdlLocation = "http://localhost:8080/soap/DemoService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName DEMOSERVICE_QNAME = new QName("http://soap/", "DemoService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/soap/DemoService?wsdl");
    ...
    public Demo getDemoPort() {
        return super.getPort(new QName("http://soap/", "DemoPort"), Demo.class);
    }
    ...
    public Demo getDemoPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap/", "DemoPort"), Demo.class, features);
    }
