...
import com.company.groovy.MyMath
import spock.lang.Specification

class NuclearReactorSpec extends Specification {

    def "multiple inputs test" () {
        given: "a math"
        ...
        math.isEvenNumber == expectedIsEvenNumber

        where: "multiple inputs"
        // The || notation is used to split the inputs from output.
        x   | y   || expectedResult | expectedIsEvenNumber
        1   | 1   || 2              | true
        1   | 2   || 3              | false
        2   | 4   || 6              | true
        3   | 2   || 5              | false
