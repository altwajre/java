...
public class MockTest {
  ...
  public void stubbingBDD() {
    // given
    given(mockedList.get(0))
        .willReturn("first");
    given(mockedList.get(1))
        .willReturn(new RuntimeException());

    // when
    final String first = (String) mockedList.get(0);
    final String exception = mockedList.get(1).toString();
