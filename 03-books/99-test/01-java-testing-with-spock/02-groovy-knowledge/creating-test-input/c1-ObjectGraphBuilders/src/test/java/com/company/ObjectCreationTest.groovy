...
import com.company.assets.AssetInventory
import spock.lang.Specification

class ObjectCreationTest extends Specification {
    def "ObjectGraphBuilder quick object creation"() {
        when:
        ObjectGraphBuilder builder = new ObjectGraphBuilder() // Creating the builder
        builder.classNameResolver = "com.company.assets" // Instructing the builder of that domain Java package

        AssetInventory shipRegistry = builder.assetInventory() { // Using the builder for the top-level object
            ship ( name: "Sea Spirit", destination:"Chiba") { // Map-based constructors
                ...
                cargo(type:"Cotton", tons:5.4) {
                    cargoOrder ( buyer: "Rei Hosokawa",city:"Yokohama",price:34000) // Children node automatically created and attached to parent
                }
