...
https://www.safaribooksonline.com/library/view/scala-design-patterns/9781788471305/05154255-a474-47c2-9e71-fce785ef0a64.xhtml
...
trait CookingComponent {
  ...
  class CookerImpl extends Cooker {
    override def cook(what: String): Food = {
      ...
      Food(s"Cooked $what using recipe: '$recipeText'.")
    }
  }
}
...
/*
The time is: 18:46:09
Food(Cooked chips using recipe: 'Fry the potatoes for 10 minutes.'.)
Food(Cooked sandwich using recipe: 'Put butter, ham and cheese on the bread, toast and add tomatoes.'.)
 */
