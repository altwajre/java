...
-- Error Code: 1451. Cannot delete or update a parent row: a foreign key constraint fails (`test`.`members`, CONSTRAINT `members_ibfk_1` FOREIGN KEY (`membership_id`) REFERENCES `memberships` (`membership_id`))
