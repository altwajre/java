...
public class App 
{
    ...
    static class Deck<T extends Card>{
        ...
        public void print(){ for(Card card : cards){ card.print(); } }
    }
    ...
    static class BlackJackCard extends Card{
        ...
        public boolean isFaceCard(){ return faceValue >= 11 && faceValue <= 13; }
    }
    ...
    static class BlackJackGameAutomator{
        ...
        public BlackJackGameAutomator(int numPlayers){
            ...
            for(int i = 0; i < numPlayers; i++){ hands[i] = new BlackJackHand(); }
        }
        ...
        public boolean playAllHands(){
            for(BlackJackHand hand : hands){ if(!playHand(hand)) return false; }
            return true;
        }
        public ArrayList<Integer> getWinners() {
            ...
            for (int i = 0; i < hands.length; i++) {
                ...
                if (!hand.busted()) {
                    ...
                    else if (hand.score() == winningScore) winners.add(i);
                }
            }
            return winners;
        }
