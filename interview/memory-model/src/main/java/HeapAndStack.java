...
- If not explicitly initialized, a primitive instance variable is given a value according to its type (int to '0', float to '0.0')
...
public class HeapAndStack {
  public static void main(String[] args) {
    ...
    System.out.println("localRef1.firstName: " + localRef1.instVar1);
    System.out.println("localRef1.lastName: " + localRef1.instVar2);
  }
}
/*
localRef1.firstName: aaa
localRef1.lastName: ccc
 */
