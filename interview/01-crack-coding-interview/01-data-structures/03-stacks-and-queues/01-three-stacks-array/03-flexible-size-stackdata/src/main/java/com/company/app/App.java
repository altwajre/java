...
A: allow the stack blocks to be flexible in size. When on stack exceeds its initial capacity,
we grow the allowable capacity and shift elements as necessary.
We design our array to be circular, such that the final stack may start at the end of the array
