...
Query query = session.createQuery("select t from Transaction t where t.amount < 25");
Query query = session.createQuery("select t from Transaction t where t.amount > 75 and t.transactionType = 'Withdrawl'");
